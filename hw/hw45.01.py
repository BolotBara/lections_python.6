...
# class Person:
#     def __init__(self, name="John", phone_number="+996 557 55 17 57", card_number="9999 9999 9999 9999"):   
#         self.name = name
...
# class Person:
#     def __init__(self, name="John", phone_number="+996 557 55 17 57", card_number="9999 9999 9999 9999", john =("John", "+996 557 55 17 57" , "9999 9999 9999 9999")):   
#         self.name = name
#         self._phone_number = phone_number
#         self.__card_number = card_number
#         self.john = john
...
# job = Person()
# print(job.name)
# print(job._phone_number)
# print(job._Person__card_number)
# print(job.john)
...
# print('Card Number:', sam._Person__card_number)
...
# class Person:
#     def __init__(self, name="John", phone_number="+999 557 55 17 57", card_number="9999999999999999"):   
#         self.name = name
#         self._phone_number = self.__validate_phone_number(phone_number)
#         self.__card_number = self._validate_cart_number(card_number)

#     def __validate_phone_number(self, phone_number):
#         if phone_number[1:4] == '999':
#             return phone_number
#         else:
#             return None

#     def _validate_cart_number(self, card_number):
#         if len(card_number) != 16 or not all(x.isdigit() for x in card_number):
#             return None
#         else:
#             return card_number

# tolik = Person()
# print('Name:', tolik.name)
# print('Phone Number:', tolik._phone_number)
# print('Card Number:', tolik._Person__card_number)
...
# game = Game()
# print('До:', game.get_level())
# game.play(3)
# game.play(1)
# print('После:', game.get_level())
...
class Game:
    ...
    def __validate_name(self, name) -> None:
        return name.title()
