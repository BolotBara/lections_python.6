...
# number = int(input('Введите число которое хотите поделить на 7 или 17: '))
# if number not in range(1000, 10000):
#     raise ValueError('Ваше число не 4-х значное!')
# else: 
#     if number % 7 or 17 == 0:
#         print('Yes! Ваше число красивое!')
#     else:
#         print('No! Ваше число некрасивое!')
...
# if thisdict[name] < 17:
#     print('Вам в клуб ещё рано идите делайте домашку!')
# else:
